...
import {createFeedback , getFeedbackById , updateFeedback , softDeleteFeedback , makeIsDeletedFalse , acknowledgeFeedback , getEmployeeFeedback , getManagerFeedback , bulkCreateFeedback , exportEmployeeFeedback , exportManagerFeedback , getFeedbackStats} from "../controllers/feedback.controllers.js";
...
feedbackRouter.route("/feedbackExportForManagers").post(verifyJwt , exportManagerFeedback);

feedbackRouter.route("/feedbackStats").get(verifyJwt , getFeedbackStats);
